...
class TestHybridSearch:
    def test_returns_documented_shape(self, client):
        ...
        assert body["config"]["reranked"] is True
...
class TestAIOverviewRateLimit:
    def test_limit_is_enforced_then_recovers(self, client, monkeypatch):
        monkeypatch.setattr(
            main,
            "generate_ai_overview",
            lambda q, results: {
...
class TestProbes:
    ...
    def test_ready_reports_not_ready_when_the_database_is_down(self, client, monkeypatch):
